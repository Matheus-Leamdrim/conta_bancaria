...
export function main() {
    ...
    contas.cadastrar(new ContaCorrente(contas.gerarNumero(), 123, 1, "Mariana", 15000, 1000));
    
    contas.cadastrar(new ContaPoupanca(contas.gerarNumero(), 123, 2, "Victor", 1000, 10));
